                ...
                <div class="md-4">
                    ...
                    <form class="form" action="./Cita" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width: 250px" name="TipoCita" readonly="readonly">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<%= request.getParameter("IdTipoCita")%>"  name="IdTipoCita" type="text" placeholder="Ingrese ID Tipo Cita" readonly="readonly"/>
                        </div>
                        <div class="form-group">
                            <label  for="Especialidad" class="form-label">Tipo de especialidad</label>
                            <select class="form-control" style="width: 250px" name="Especialidad" readonly="readonly">
                                <option value="-1">Selecciona el tipo de cita</option>
                                <%
                                    try {
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<%= request.getParameter("IdEspecialidad")%>"  name="IdEspecialidad" type="text" placeholder="Ingrese ID Tipo Cita" readonly="readonly"/>
                        </div>
                        <div class="form-group">
                            <label  for="ApellidoM" class="form-label">Apellido M.</label>
                            <select class="form-control" style="width: 250px" name="ApellidoM" readonly="readonly"> 
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<%= request.getParameter("IdMedico")%>"  name="IdMedico" type="text" placeholder="Ingrese ID Tipo Cita" readonly="readonly"/>
                        </div>
                        <div class="form-group">
