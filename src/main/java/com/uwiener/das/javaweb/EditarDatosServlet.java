    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sHtml = objVHtml.getHeader() + objVHtml.getBody()
                    ...
                    + "                            <input type=\"text\" class=\"search form-control\" placeholder=\"Buscar\" aria-label=\"Search\" aria-describedby=\"search-addon\" />  "
                    + "                   </div><br>"
                    ...
                    + "                            <td colspan=\"8\"><i class=\"fa fa-warning\"></i>Datos no existen</td>\n"
                    + "                        </tr>\n";
            while (rs.next()) {
                sTabla += "<tr>\n"
                        + "   <td>" + rs.getInt(1) + "</td>\n"
