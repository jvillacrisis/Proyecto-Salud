        ...
        <div class="container">
            <div class="row">
                ...
                <div class="md-4">
                    ...
                    <form class="form" action="./EditarDatos" method="POST">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2">
                        ...
                        <input type="hidden" value="EDP" name="accion"/>
                        <br>
                    ...
                    <br>
                    <div class="col-md-12 text-center center-block">
                        <a href="./EditarDatos"><button class="btn btn-secondary">Cancelar</button></a>
                    </div>
                </div>
                <div class="md-4"></div>
            </div>
